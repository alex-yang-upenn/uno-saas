...
import { EditorCanvasCardType, Option } from './types'
...
export const onAddTemplateSlack = (nodeConnection: ConnectionProviderProps, template: string) => {
  nodeConnection.setSlackNode((prev: any) => ({...prev, content: `${prev.content} ${template}`}))
}

export const onAddTemplateDiscord = (nodeConnection: ConnectionProviderProps, template: string) => {
  nodeConnection.setDiscordNode((prev: any) => ({...prev, content: `${prev.content} ${template}`}))
}

export const onAddTemplateNotion = (nodeConnection: ConnectionProviderProps, template: string) => {
  nodeConnection.setNotionNode((prev: any) => ({...prev, content: `${prev.content} ${template}`}))
}
