...
export const HeroParallax = ( {products}: {products: {title: string, link: string, thumbnail: string}[]} ) => {
  ...
  return (
    <div ref={ref} className="h-[310vh] overflow-hidden antialiased relative flex flex-col self-auto [perspective:1000px] [transform-style:preserve-3d] ">
      <Header />
      <motion.div style={{rotateX, rotateZ, translateY, opacity}} className="">
        ...
        <motion.div className="flex flex-row space-x-20 mb-5">
...
export const Header = () => {
  return (
    <div className="flex justify-center items-center max-w-7xl relative mx-auto py-20 md:py-40">
      <div>
