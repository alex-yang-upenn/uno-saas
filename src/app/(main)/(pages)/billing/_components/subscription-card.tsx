...
type Props = {onPayment(id: string): void, products: any[], tier: string}
              ...
              <CardDescription>
                {product.nickname == "Unlimited"
                  ...
                  : product.nickname == 'Free' &&
                    "Get a monthly wave of credits to automate your tasks with ease. Perfect for starters looking to dip their toes into Uno's automation capabilities."}
              </CardDescription>
              <div className="flex justify-between">
                <p>
                  {product.nickname == "Free" ? "10" : product.nickname == "Pro" ? "100" : product.nickname == "Unlimited" && "Unlimited"}{" credits"}
                </p>
                <p className="font-bold">
                  {product.nickname == "Free" ? "Free" : product.nickname == "Pro" ? "29.99/mo" : product.nickname == "Unlimited" && "99.99/mo"}
                </p>
              </div>
